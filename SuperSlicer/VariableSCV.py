...
with open(dest_file, "w") as of:
    ...
    of.write('_USE_INTERNAL_PERIMETER_SCV\n')
    of.write('_USE_EXTERNAL_PERIMETER_SCV\n')
    of.write('_USE_OVERHANG_PERIMETER_SCV\n')
    of.write('_USE_INTERNAL_INFILL_SCV\n')
    of.write('_USE_SOLID_INFILL_SCV\n')
    of.write('_USE_IRONING_SCV\n')
    of.write('_USE_BRIDGE_INFILL_SCV\n')
    of.write('_USE_INTERNAL_BRIDGE_INFILL_SCV\n')
    of.write('_USE_GAP_FILL_SCV\n')
    of.write('_USE_SUPPORT_MATERIAL_SCV\n')
    of.write('_USE_SUPPORT_MATERIAL_INTERFACE_SCV\n')
    of.write('_USE_WIPE_TOWER_SCV\n')
    of.write('_USE_TRAVEL_SCV\n')
