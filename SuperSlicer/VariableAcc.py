...
with open(dest_file, "w") as of:
    ...
    of.write('_USE_INTERNAL_PERIMETER_ACC\n')
    of.write('_USE_EXTERNAL_PERIMETER_ACC\n')
    of.write('_USE_OVERHANG_PERIMETER_ACC\n')
    of.write('_USE_INTERNAL_INFILL_ACC\n')
    of.write('_USE_SOLID_INFILL_ACC\n')
    of.write('_USE_IRONING_ACC\n')
    of.write('_USE_BRIDGE_INFILL_ACC\n')
    of.write('_USE_INTERNAL_BRIDGE_INFILL_ACC\n')
    of.write('_USE_GAP_FILL_ACC\n')
    of.write('_USE_SUPPORT_MATERIAL_ACC\n')
    of.write('_USE_SUPPORT_MATERIAL_INTERFACE_ACC\n')
    of.write('_USE_WIPE_TOWER_ACC\n')
    of.write('_USE_TRAVEL_ACC\n')
    of.write('_USE_NORMAL_ACC\n')
