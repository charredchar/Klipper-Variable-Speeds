...
with open(dest_file, "w") as of:
    of.write('; Ensure ACC macros are properly setup in Klipper\n')
    of.write('_USE_NORMAL_ACC\n')
    of.write('_USE_INNER_WALL_ACC\n')
    of.write('_USE_OUTER_WALL_ACC\n')
    of.write('_USE_OVERHANG_WALL_ACC\n')
    of.write('_USE_SPARSE_INFILL_ACC\n')
    of.write('_USE_INTERNAL_SOLID_INFILL_ACC\n')
    of.write('_USE_IRONING_ACC\n')
    of.write('_USE_BRIDGE_ACC\n')
    of.write('_USE_INTERNAL_BRIDGE_ACC\n')
    of.write('_USE_SUPPORT_ACC\n')
    of.write('_USE_PRIME_TOWER_ACC\n')
